...
HD_PWD='C:/Users/MUSAB/Desktop/DigitalProject/DigitalProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ElevatorSystem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ElevatorSystem.tcl
