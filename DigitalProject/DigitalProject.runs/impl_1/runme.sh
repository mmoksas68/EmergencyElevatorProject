...
HD_PWD='C:/Users/MUSAB/Desktop/DigitalProject/DigitalProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ElevatorSystem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ElevatorSystem.tcl -notrace
